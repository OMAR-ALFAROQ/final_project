        ...
        <!-- partial -->
            ...
            <div class="row">
                ...
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    <img src="../assets/images/dashboard/users.svg" class="card-img-absolute" alt="users-image" />
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="../assets/images/dashboard/category.png" class="card-img-absolute" alt="circle-image" />
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    <img src="../assets/images/dashboard/admin.jpg" class="card-img-absolute" alt="circle-image" />
